        ...
        if entity.location[1] < server_settings.MAP_DIMENSIONS[1]:
            if entity.entity_id == 'player':
                if world_map[entity.location[0]][entity.location[1] + 1].properties.is_occupied == False:
                    del world_map[entity.location[0]][entity.location[1]].players[entity.player_id]
                    entity.location[1] += 1
                    world_map[entity.location[0]][entity.location[1]].players[entity.player_id] = entity
                    print("just updated: ", entity.player_id)
